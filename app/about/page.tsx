    ...
    <div className="min-h-screen flex flex-col bg-background text-foreground transition-colors duration-300">
      ...
      <main className="flex-1">
          ...
          <div className="container mx-auto px-6 max-w-7xl relative z-10">
            <div className="flex flex-col items-center text-center">
              ...
              <div className="flex justify-center mb-4 animate-pulse">
                <svg className="w-16 h-16 text-primary" viewBox="0 0 100 100" fill="none" stroke="currentColor" strokeWidth="1.5">
                  <path d="M50 15c15 0 30 5 30 25 0 20-20 38-30 45-10-7-30-25-30-45 0-20 15-25 30-25z" className="fill-primary/5" />
                  <circle cx="50" cy="45" r="18" strokeDasharray="3 3" />
                  <path d="M50 32l5 13-5 5-5-5z" className="fill-primary" stroke="currentColor" strokeWidth="1.5" />
              ...
              <span className="font-mono-tech text-[11px] uppercase tracking-[0.2em] text-primary mb-6">
                [ ABOUT AERO HIVE / EST 2023 ]
              </span>

              {/* Logo / Badge integration */}
              <div className="relative mb-8 group">
                <div className="h-28 w-28 rounded-2xl overflow-hidden shadow-2xl transition-all duration-500 bg-white border border-primary/35 p-2 flex items-center justify-center">
                  <Image
              ...
              <h1 className="font-display text-4xl sm:text-6xl lg:text-7xl font-black tracking-tighter uppercase leading-[0.9] max-w-5xl mb-6 text-foreground">
                We design <span className="text-primary">autonomous</span> aerial platforms.
              </h1>
              ...
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 w-full border border-border/40 p-1 bg-card/50 backdrop-blur-sm rounded-xl">
                {stats.map((stat, index) => {
                  ...
                  return (
                    <div key={index} className="p-6 border border-border/30 rounded-lg flex flex-col items-center justify-center bg-background text-center transition-all hover:border-primary/40 hover:-translate-y-0.5 duration-200">
          ...
          <div className="container mx-auto px-6 max-w-7xl">
            <div className="grid lg:grid-cols-12 gap-12 items-start">
              ...
              <div className="lg:col-span-5">
                <span className="font-mono-tech text-[11px] uppercase tracking-[0.2em] text-primary mb-4 block">
                  01 / TARGET & STRATEGY
                </span>
        ...
        <section className="py-20 border-b border-border/40 bg-background relative overflow-hidden">
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_70%_120%,hsl(from_var(--primary)_h_s_l/0.05),transparent_50%)] pointer-events-none" />
          <div className="container mx-auto px-6 max-w-7xl relative z-10">
            <div className="p-8 md:p-12 border border-primary/20 rounded-3xl bg-card/45 backdrop-blur-md max-w-4xl mx-auto flex flex-col md:flex-row items-center gap-8 shadow-sm">
              <div className="space-y-4 flex-1">
                <span className="font-mono-tech text-[10px] uppercase tracking-[0.2em] text-primary">
              ...
              <div className="flex-shrink-0 w-24 h-24 rounded-full border border-primary/30 flex items-center justify-center bg-primary/5 animate-pulse">
              ...
              {timeline.map((item, index) => {
                ...
                return (
                  <div key={index} className="relative group">
                    {/* Timeline Node Point */}
                    <div className={`absolute -left-[31px] top-1.5 h-4 w-4 rounded-full border-2 bg-background transition-all duration-300 ${isActive ? 'border-primary bg-primary scale-125' : 'border-border'}`} />

                    <div className={`p-6 border border-border/40 rounded-xl bg-card/40 backdrop-blur-sm transition-all duration-300 ${isActive ? 'border-primary/45 shadow-[0_4px_20px_hsl(from_var(--primary)_h_s_l/0.05)]' : ''}`}>
                      <div className="flex flex-wrap items-center gap-3 mb-2">
                        <span className="font-mono-tech text-xs font-bold text-primary">{item.year}</span>
          ...
          <div className="container mx-auto px-6 max-w-7xl">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {values.map((val, index) => (
                <div key={index} className="p-6 border border-border/40 bg-card/65 rounded-xl hover:border-primary/30 transition-colors duration-200">
          ...
          <div className="container mx-auto px-6 max-w-7xl">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {team.map((member, index) => (
                <a key={index} href={member.linkedin} target="_blank" rel="noopener noreferrer" className="block h-full group">
                  <div className="h-full border border-border/40 rounded-xl overflow-hidden bg-card/30 backdrop-blur-sm hover:border-primary/40 hover:shadow-lg transition-all duration-300 flex flex-col">
                    ...
                    <div className="p-6 flex-1 flex flex-col">
                      ...
                      <p className="font-mono-tech text-[10px] text-primary uppercase tracking-wider mb-4">{member.role}</p>
            ...
            <div className="mt-20 pt-16 border-t border-border/40">
              <div className="text-center mb-12">
                <span className="font-mono-tech text-[10px] uppercase tracking-[0.2em] text-primary mb-2 block">
                  CONTRIBUTORS
                </span>
              ...
              <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto w-full px-4">
                {[
                  ...
                  <div 
                    key={i} 
                    className="group relative p-8 border border-border/40 rounded-2xl bg-card/20 backdrop-blur-md transition-all duration-300 hover:border-primary/50 hover:shadow-lg hover:-translate-y-1 flex flex-col justify-between overflow-hidden"
                  >
                    {/* Background Accent glow */}
                    <div className="absolute -right-16 -top-16 w-32 h-32 bg-primary/5 rounded-full blur-2xl group-hover:bg-primary/10 transition-colors duration-500" />
                    
                    <div>
                      {/* Header block with Initials and Role Badge */}
                      <div className="flex items-start justify-between mb-6">
                        <div className="h-12 w-12 rounded-2xl bg-primary flex items-center justify-center text-primary-foreground font-display text-sm font-bold shadow-lg shadow-primary/10 shrink-0">
                          {contributor.initials}
                        </div>
                        <span className="font-mono-tech text-[9px] font-bold text-primary uppercase tracking-widest px-3 py-1 bg-primary/8 border border-primary/15 rounded-full">
                          {contributor.role}
                        </span>
                      </div>

                      {/* Name & Tagline */}
                      <h4 className="font-display text-base font-black uppercase text-foreground mb-1 group-hover:text-primary transition-colors duration-200">
                        {contributor.name}
                      </h4>
        ...
        <section className="py-20 bg-[#0c0a09] text-white">
          <div className="container mx-auto px-6 max-w-4xl text-center space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4">
              <Button size="lg" className="bg-primary hover:bg-primary/90 text-primary-foreground rounded-full font-mono-tech text-xs uppercase tracking-wider px-8 cursor-pointer" asChild>
