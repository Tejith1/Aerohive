          ...
          if (isManualLoginRef.current) {
            ...
            if (!profileSet) {
              ...
              setUser({
                ...
                is_admin: authUser.email === 'admin1@gmail.com' || authUser.email === 'charansaitej021206@gmail.com' || authUser.email === 'admin@aerohive.com',
                provider: authUser.app_metadata?.provider || 'email'
              })
            }
  ...
  const login = async (email: string, password: string) => {
    try {
      ...
      if (data.user) {
        ...
        const isAdminEmail = authUser.email === 'admin1@gmail.com' || authUser.email === 'charansaitej021206@gmail.com' || authUser.email === 'admin@aerohive.com'
